package ca.jovanifrancis.myquotesapplication.categories;
...
import ca.jovanifrancis.myquotesapplication.Quotes;
import ca.jovanifrancis.myquotesapplication.R;
    ...
    public void onBindViewHolder(@NonNull CategoriesAdapter.MyViewHolder holder, int position) {
        ...
        holder.categoryImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Log.i("Jovi",list2.getCategoryName());
...
//        });
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        //private final Layout categoryContainer;

        public MyViewHolder(@NonNull View itemView) {
            super(itemView);

            categoryName = itemView.findViewById(R.id.categoryName);
            categoryImage = itemView.findViewById(R.id.categoriesImage);
